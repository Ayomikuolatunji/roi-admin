...
export default function Local() {
    ...
    const [productType]=React.useState("MINERAL")
    ...
    const [updateType]=React.useState("MINERAL")
   ...
   {prodLoading ?  <Segment>
    ...
    <Table.Body>
        ...
        <Table.Cell><h1 className='text-red-500 text-xl'>Cant load product lists due to bad internet connection</h1></Table.Cell>
            ...
            if(product_type.toLowerCase()==="MINERAL".toLowerCase()){
